 ...
 * <dl>
 * <dt>sortin=&lt;dsn&gt;</dt>
 * <dd>The name of a RECFM=V dataset to copy.  Supplied to DFSORT as SORTIN.</dd>
 * <dt>sortout=&lt;dsn&gt;</dt>
 * <dd>The name of a RECFM=V dataset to receive the copied data.  Supplied to DFSORT as SORTOUT.</dd>
 ...
 * <li>Specify an existing RECFM=V existing dataset as output (SORTOUT) to DFSORT
 * <li>Copy the records from SORTIN to SORTOUT
 * </ul>
 */
public class DfSortCopyVariableDataset {
	...
	public static void main(String[] args) throws Exception {
		...
		if ((dfsortArgs.getSortinDataset() == null) || (dfsortArgs.getSortoutDataset() == null)) { 
    		System.err.println("Usage: " + DfSortCopyVariableDataset.class.getName() + " sortin=<dsn> sortout=<dsn> [shareas=<yes|NO>]");
    		System.err.println("Where:");
    		System.err.println("\tsortin is a RECFM=V dataset");
    		System.err.println("\tsortout is a RECFM=V dataset");
	...
	private static void doSort(DfSortArguments dfsortArgs) throws Exception {
		...
		//Specify that the DFSORT child process should be run in a separate address space.
		...
		System.out.println("RC=" + rc + " DFSORT_TIME=" + dfsortRuntime + " ZFILE_TIME=" + zfileRuntime + " RECORD COUNT=" + recordCount + " "
				+ DfSortCopyVariableDataset.class.getName());		
