 ...
 * <dl>
 * <dt>sortin=&lt;dsn&gt;</dt>
 * <dd>The name of a RECFM=V dataset to sort.  Supplied to DFSORT as SORTIN.</dd>
 * <dt>sortout=&lt;dsn&gt;</dt>
...
public class DfSortVariableDatasetToVariableDataset {
	...
	public static void main(String[] args) throws Exception {
		...
		if ((dfsortArgs.getSortinDataset() == null) || (dfsortArgs.getSortoutDataset() == null)) { 
    		System.err.println("Usage: " + DfSortVariableDatasetToVariableDataset.class.getName() + " sortin=<dsn> sortout=<dsn> [shareas=<yes|NO>]");
	...
	private static void doSort(DfSortArguments dfsortArgs) throws Exception {
		...
		System.out.println("RC=" + rc + " TIME=" + runtime + " RECORD COUNT=" + recordCount + " "
				+ DfSortVariableDatasetToVariableDataset.class.getName());		
